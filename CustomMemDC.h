...
public:
    ...
    CCustomMemDC(CDC* pDC) : CDC()
    {
        ...
        m_bCustomMemDC = !pDC->IsPrinting();
#else
        m_bCustomMemDC = FALSE;
#endif

        if (m_bCustomMemDC)    // Create a Memory DC
        {
...
private:
    ...
    BOOL     m_bCustomMemDC;      // TRUE if CDC really is a Memory DC.
};
